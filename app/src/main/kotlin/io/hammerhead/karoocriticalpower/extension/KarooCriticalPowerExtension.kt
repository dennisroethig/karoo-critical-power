...
class KarooCriticalPowerExtension : KarooExtension("karoo-critical-power", "1.0") {
    ...
    private val criticalPower5s by lazy { CriticalPower5sDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower15s by lazy { CriticalPower15sDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower30s by lazy { CriticalPower30sDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower1m by lazy { CriticalPower1mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower3m by lazy { CriticalPower3mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower5m by lazy { CriticalPower5mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower20m by lazy { CriticalPower20mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower30m by lazy { CriticalPower30mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower45m by lazy { CriticalPower45mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower1h by lazy { CriticalPower1hDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
    private val criticalPower1h30m by lazy { CriticalPower1h30mDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }

    // Power curve overview (all durations as bars)
    private val powerCurveOverview by lazy { PowerCurveOverviewDataType(extension, karooSystem, powerCurveRepository, showPrComparison) }
